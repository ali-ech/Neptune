...
import { IconMail, IconMapPin, IconPhone, SOCIAL_ICONS } from '../components/ui/Icons';
...
const { contact, social } = FOOTER_COLS;
          ...
          <div className="contact-info">
            ...
            <div className="contact-cards">
              <article className="contact-card">
                <div className="contact-card-icon-wrap" aria-hidden>
                  <IconMail size={22} />
                </div>
