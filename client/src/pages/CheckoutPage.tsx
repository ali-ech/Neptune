...
export default function CheckoutPage() {
  ...
  useEffect(() => {
    ...
    const stored = sessionStorage.getItem('neptune-order-notes');
    ...
    if (incoming) {
      ...
      sessionStorage.removeItem('neptune-order-notes');
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    setLoading(true);
    const orderId = `NPT-${Date.now().toString(36).toUpperCase()}`;
    const orderDetails = {
      orderId,
          ...
          <div className="section-inner">
            <div className="checkout-success">
              ...
              <p className="checkout-success-text">
                ...
                Payment will be collected upon delivery. We appreciate your trust in Neptune Mineral Water.
              </p>
